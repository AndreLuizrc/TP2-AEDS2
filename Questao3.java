...
public class Questao3 {
    ...
    public static void preencherVetor(Personagem[] personagens, String[] ids){
        String line;
        String[] atributos;
        ...
        try {
            ...
            while(sc.hasNextLine()){
                ...
                for(int j = 0; j < ids.length; j++){
                    if(ids[j].equals(atributos[0]) == true){
                        try {
    ...
    public static void PesquisaSequencial(Personagem[] personagens, String nome) {
